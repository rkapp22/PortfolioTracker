...
- [ ] Vähemalt üks näidikulaud on nähtaval — Power BI mudel ja `Dashboard.pbip` on olemas, aga käivitatav raporti kuvamine nõuab Power BI Desktopi ja ei ole automaatselt testitud.
